...
// ** Services
import { fetchChefStatistics } from "@/services/statisticService";
...
const ChefChart = ({ theme }: Props) => {
  ...
  function handleMonthChange(value: string) {
    searchParams.set("chef_months", value);
  ...
  const { data, refetch } = useQuery({
    queryKey: ["chef-chart"],
    queryFn: () => fetchChefStatistics(searchParams),
    ...queryOptions,
  });
    ...
    <Paper
      ...
      <Stack
        ...
        <Typography
          ...
          Total Chef Across {searchParams.get("chef_months") || 3} Months
        </Typography>
      ...
      <ResponsiveContainer width="100%" height={400}>
        <BarChart margin={{ right: 40 }} data={chefData}>
          <CartesianGrid
            strokeDasharray="3 3"
